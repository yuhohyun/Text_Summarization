...
class ArgsBase():
    ...
    def add_model_specific_args(parent_parser):
        ...
        parser.add_argument('--train_file',
                            type=str,
                            default='/content/drive/MyDrive/Final_Project/TextSummarization/KoBART-summarization/data/train_add.tsv',
                            help='train file')
        parser.add_argument('--test_file',
                            type=str,
                            default='/content/drive/MyDrive/Final_Project/TextSummarization/KoBART-summarization/data/test_add.tsv',
                            help='test file')
